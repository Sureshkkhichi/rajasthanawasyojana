...
class AllotmentExpiryService
{
    ...
    public function expireOldAllotments(): int
    {
        ...
        foreach ($expiredDeals as $deal) {
            ...
            if ($unit) {
                ...
                InventoryHistory::create([
                    ...
                    'notes' => 'Unit allotment automatically cancelled after 5 minutes (Testing Mode) without being marked Sold.',
                ]);
        ...
        if ($count > 0) {
            Log::info("AllotmentExpiryService: Expired {$count} unit allotment(s) older than 5 minutes (Testing Mode).");
        }
