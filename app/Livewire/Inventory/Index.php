    ...
    public function submitSoldAllotment(): void
    {
        ...
        if ($this->createNewDealMode) {
            ...
            $this->validate([
                ...
                'newDealForm.pan_number' => ['required', 'string', 'regex:/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/i'],
                ...
                'newDealForm.pan_number.regex' => 'Please enter a valid 10-character PAN number (e.g. ABCDE1234F).',
