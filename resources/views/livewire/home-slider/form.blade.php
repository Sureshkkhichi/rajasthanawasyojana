                        ...
                        <div class="card">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Enter subtitle" wire:model="subtitle">
                                        @error('subtitle')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        ...
                                        <select class="form-select rounded-pill @error('status') is-invalid @enderror"
                                            wire:model="status">
                                            <option value="active">
                                                Active
                                            </option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file"
                                            ...
                                            wire:model="desktop_image_file" accept="image/*">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file"
                                            ...
                                            wire:model="mobile_image_file" accept="image/*">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Explore Now" wire:model="button_text">
                                        @error('button_text')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        ...
                                        <select class="form-select rounded-pill" wire:model.live="link_type">
                                            <option value="custom">
                                                Custom URL
                                            </option>
                                    ...
                                    @if ($link_type === 'custom')
                                        <div class="col-xxl-6 col-md-12">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="https://example.com" wire:model="button_link">
                                            @error('button_link')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end gap-2 flex-wrap">
                                    <a href="{{ route('home-sliders.index') }}" class="btn btn-light">
                                        Cancel
                                    </a>
                                    ...
                                    @if (!$isEdit)
                                        <button type="button" class="btn btn-success" wire:click="saveAndNew"
