                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                                placeholder="Enter 3 to 5-digit Waiver Code" wire:model="code" maxlength="5" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            <button class="btn btn-outline-secondary" type="button" wire:click="generateCode">
                                                <i class="ri-refresh-line me-1"></i> Auto-generate
                                            </button>
                                        </div>
                                        <small class="text-muted">A 3 to 5-digit unique numeric code to identify the agent on Booking / Lead forms.</small>
