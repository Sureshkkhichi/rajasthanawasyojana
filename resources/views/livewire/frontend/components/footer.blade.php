<div>
    ...
    <div class="py-3 text-center" style="background: linear-gradient(135deg, #4a1510 0%, #7c4c2d 100%); color: #fff;">
        <div
            class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between gap-3">
            <div class="text-center text-md-start">
                <h5 class="fw-bold mb-1" style="color: #f6eedf !important;">
                    <i class="ri-award-line me-1 text-warning"></i> मुख्यमंत्री जन आवास योजना - आवंटन पत्र / लॉटरी
                    परिणाम
                </h5>
            ...
            <div>
                <a href="{{ route('allotment-result') }}"
                    class="btn btn-danger btn-lg fw-bold rounded-pill shadow-sm px-4 py-2"
