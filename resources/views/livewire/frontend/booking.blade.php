                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                @if($this->isValidWaiverCode && $this->waiverDiscountAmount > 0)
                                    <h3 class="" style="font-weight: 500;">
                                        Registration Amount Rs. <span class="text-decoration-line-through text-muted">{{ number_format($this->baseBookingAmount) }}</span>
                                        <strong class="text-success">{{ number_format($this->payableBookingAmount) }}</strong>
                                        <small class="text-success fs-14">(-₹{{ number_format($this->waiverDiscountAmount) }} Discount)</small>
                                    </h3>
                                @else
                                    <h3 class="" style="font-weight: 500;">Registration Amount Rs. {{ number_format($this->payableBookingAmount) }}</h3>
                                @endif
                            </div>
                        </div>
                        <!-- TERMS -->
