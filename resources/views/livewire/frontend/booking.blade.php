                    ...
                    <div class="card-body p-3 p-lg-3">
                        <form wire:submit.prevent="submit" class="position-relative">
                            ...
                            <div wire:loading wire:target="submit" style="display: none;">
                                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center rounded shadow"
                                    ...
                                    <div class="text-center" style="position: sticky; top: 50%;">
                                        ...
                                        <h5 class="text-success mt-3 fw-semibold">Processing booking form, please wait...
                                        </h5>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-0">
                                            ...
                                            <input type="text"
                                                ...
                                                wire:model.live.debounce.300ms="waiver_code" maxlength="5"
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            @if(!empty($waiver_code))
                                                @if($this->isValidWaiverCode)
                                                    <small class="text-success fw-semibold d-block mt-1">✓ Valid Code!
                                                        ₹{{ number_format($this->waiverDiscountAmount) }} Discount Applied</small>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12 form-group">
                                    @if(!empty($flat_size) && $this->total_value)
                                        ...
                                        <h2 id="total"
                                            style="border-bottom: 2px dotted #000; min-height: 42px; display: flex; align-items: center;"
                                            class="text-success fw-bold">
                                            ₹ {{ indianCurrency($this->total_value) }}
                                        </h2>
                                    @endif
                                    @if($this->isValidWaiverCode && $this->waiverDiscountAmount > 0)
                                        <h3 class="" style="font-weight: 500;">
                                            Registration Amount Rs. <span
                                                class="text-decoration-line-through text-muted">{{ number_format($this->baseBookingAmount) }}</span>
                                            <strong
                                                class="text-success">{{ number_format($this->payableBookingAmount) }}</strong>
                                            <small
                                                class="text-success fs-14">(-₹{{ number_format($this->waiverDiscountAmount) }}
                                                Discount)</small>
                                        </h3>
                                    @else
                                        <h3 class="" style="font-weight: 500;">Registration Amount Rs.
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success rounded-pill fw-semibold shadow-lg"
                                    style="background: #198754; border-color: #198754;" wire:loading.attr="disabled"
                                    wire:target="submit">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow-lg border-0 py-5 px-4 text-center rounded-4 bg-white">
                            <div class="card-body">
                                ...
                                <a href="{{ route('front') }}"
                                    class="btn btn-primary px-4 py-2 fs-15 rounded-pill shadow-sm"
                                    style="background-color: #ff0000; border-color: #ff0000; border: none;">
